          ...
          <div className={cn("w-full flex flex-col gap-6 flex-1 min-h-0")}>
            <div className={cn("w-full flex flex-row gap-6 flex-1 min-h-0")}>
              ...
              >
                <h3
                  className={cn(
                    "typo-title-2-semibold text-foreground flex-shrink-0"
                  )}
                >
                  {categoryId === "0"
                    ? "빠른매칭 일반공고 상세"
              ...
              <div
                className={cn(
                  "flex-1 flex flex-col gap-4 pr-6 overflow-y-auto min-h-0"
                )}
              >
                <h3
                  className={cn(
            ...
            <div
              className={cn(
                "w-full border-t border-border pt-[10px] pb-[10px] flex-shrink-0"
              )}
            >
              <ThunderAnnouncementForm
                contentsId={contents?.id}
