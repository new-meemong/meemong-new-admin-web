...
function DrawerContent({
  ...
  return (
    <DrawerPrimitive.Content
      ...
      className={cn(
        "group/drawer-content bg-background fixed z-50 flex h-auto flex-col pointer-events-none",
        // direction별 inset/position은 유지
        ...
        // width는 기본값만 주고, 커스텀 className이 override 하도록
